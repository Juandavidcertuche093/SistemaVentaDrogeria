...
@Component({
  selector: 'app-modalmmedicamentos',
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule, MatDialogModule, MatGridListModule, MatFormFieldModule, MatIconModule, MatSelectModule, MatInputModule, MatButtonModule, MatDatepickerModule, MatNativeDateModule, MatMomentDateModule],
  templateUrl: './modalmmedicamentos.component.html',
  styleUrl: './modalmmedicamentos.component.scss',
  providers:[
    {provide:MAT_DATE_FORMATS, useValue:MY_DATA_FORMATS},
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] } // Si usas Moment.js
  ]
})
export class ModalmmedicamentosComponent implements OnInit {
  ...
  constructor(
    private modalActual: MatDialogRef<ModalmmedicamentosComponent>,
